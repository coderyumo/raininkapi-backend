...
import com.yupi.raininkapibackend.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.yupi.raininkapibackend.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.yupi.raininkapibackend.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Boolean> updateUserInterfaceInfo(@RequestBody UserInterfaceInfoUpdateRequest userInterfaceInfoUpdateRequest,
        ...
        ThrowUtils.throwIf(oldUserInterfaceInfo == null, ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可修改
        ThrowUtils.throwIf(!oldUserInterfaceInfo.getUserId().equals(user.getId()) && !userService.isAdmin(request),
